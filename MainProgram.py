...
class StartWindow(MainsWindows):
    def __init__(self):
        super().__init__("Программа сортировщик","Белорусский Национальный технический университет",
                         "Факультет инормационных технологий и робототехники\nКафедра программного обеспечиния информационных систем и технологий",
                         "Курсовой проект\nСтедента: Гришко Д.И.\nПо теме:"
